...
namespace Project_Vacation_Manager.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Teams")] Project project)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Teams")] Project project)
        {
            if (id != project.Id)
            {
                return NotFound();
